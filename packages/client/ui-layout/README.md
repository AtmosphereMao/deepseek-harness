...
- **The phone drawer stays open after navigation** — selecting a session from the drawer does not dismiss it; the scrim or the collapse toggle closes it.
