...
export const zh = {
  ...
  'menu.aria': '模型、子代理模型与推理等级',
  'menu.model': '模型',
  'menu.subagent': '子代理模型',
  'subagent.inherit': '继承工具配置',
  'menu.effort': '推理等级',
...
export const en = {
  ...
  'menu.aria': 'Model, subagent model, and reasoning effort',
  'menu.model': 'Model',
  'menu.subagent': 'Subagent model',
  'subagent.inherit': 'Inherit tool config',
  'menu.effort': 'Effort',
  'effort.providerDefault': 'Default',
