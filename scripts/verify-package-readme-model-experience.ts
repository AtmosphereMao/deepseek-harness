...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-network': { kind: 'none', reason: 'Browser-side settings page over the shared http transport; registers nothing model-facing.' },
  ...
  'packages/http/http': { kind: 'indirect', reason: 'The shared transport applies a proxy dispatcher to requests consumers make; each consumer owns its model-facing request and error rendering.' },
